...
// Balancer Rate Provider (Optimism): [0x15ACEE5F73b36762Ab1a6b7C98787b8148447898](https://optimistic.etherscan.io/address/0x15ACEE5F73b36762Ab1a6b7C98787b8148447898#code)
    ...
    function test_optimism_deployment() public {
        DSROracleForwarderOptimism forwarderEthereum = DSROracleForwarderOptimism(0x4042127DecC0cF7cc0966791abebf7F76294DeF3);
        ...
        vm.createSelectFork(getChain('optimism').rpcUrl, 19618011);  // April 9, 2024

        assertEq(forwarderEthereum.l2Oracle(), receiverL2);
        assertEq(forwarderEthereum.pot(),      Ethereum.Pot);

        vm.createSelectFork(getChain('mainnet').rpcUrl, 118532925);  // April 9, 2024
